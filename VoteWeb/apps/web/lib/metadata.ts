...
export const SITE_NAME = 'Lunaf.kr';

export const DEFAULT_SITE_DESCRIPTION =
  '한국 마인크래프트 서버를 검색하고, 투표와 리뷰로 운영 상태를 비교하세요.';

const DEFAULT_OG_TITLE = 'Lunaf.kr';

export function getSiteUrl() {
  return normalizeSiteUrl(process.env.NEXT_PUBLIC_SITE_URL ?? 'https://lunaf.kr');
}
