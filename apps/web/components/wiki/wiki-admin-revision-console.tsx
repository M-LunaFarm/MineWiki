...
function historyPath(routePath: string) { if (routePath.startsWith('/server/') || routePath.startsWith('/serverWiki/')) return buildServerWikiToolPath(routePath, 'history'); if (routePath.startsWith('/wiki/category/')) return buildCategoryWikiToolPath(routePath, 'history'); return buildStandardWikiToolPath(routePath, 'history'); }
