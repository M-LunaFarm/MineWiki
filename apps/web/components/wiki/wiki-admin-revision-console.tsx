...
import { buildCategoryWikiToolPath, buildServerWikiToolPath, buildWikiRevisionPath } from '../../lib/wiki-routes.mjs';
...
function historyPath(routePath: string) { if (routePath.startsWith('/server/')) return buildServerWikiToolPath(routePath, 'history'); if (routePath.startsWith('/wiki/category/')) return buildCategoryWikiToolPath(routePath, 'history'); return `${routePath.replace(/\/$/, '')}/history`; }
