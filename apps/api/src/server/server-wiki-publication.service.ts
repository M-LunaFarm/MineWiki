  ...
  private async resolveContext(
    ...
    return {
      ...
      presentation: {
        ...
        seoTitle: wiki.seoTitle,
        seoDescription: wiki.seoDescription,
        seoIndexingEnabled: wiki.seoIndexingEnabled,
        brandName: wiki.brandName,
        brandLogoUrl: wiki.brandLogoUrl,
        brandFaviconUrl: wiki.brandFaviconUrl,
        brandAccentColor: wiki.brandAccentColor,
