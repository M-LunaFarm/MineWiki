...
@Module({
  imports: [ServerModule, CaptchaModule, EventsModule, SessionModule, MinecraftModule],
  providers: [VoteService, VoteQueueService, VoteDiagnosticsService, VoteStore],
  controllers: [VoteController, VoteDiagnosticsController, VoteMonitorController],
  exports: [VoteStore]
})
